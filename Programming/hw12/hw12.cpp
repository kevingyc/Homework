...
int Matrix::countercopy;
int Matrix::counteropera;
...
{
     cout << "The copy constructor is called " << countercopy << " times." << endl; 
     cout << "The assignment operator is called " << counteropera << " times." << endl; 
}
